...
- **Manifest Indigo** (#6366f1 → #4f46e5): The house colour. Appears as a 135°
  ...
  Browse Folder, Review & Add to DB — and as the solid fill of the 36px "EQ"
  logo tile and the loading spinner's leading arc. Also the active state of the
  Tradeskill Only toggle. It is the only colour allowed to mean "this is the
  thing to press".
